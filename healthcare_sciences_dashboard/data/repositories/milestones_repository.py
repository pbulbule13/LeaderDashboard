    ...
    async def get_milestones_data(self) -> ProjectMilestones:
        ...
        cologuard_milestones = [
            Milestone(
                ...
                project_name="DiagnosticTest A 2.0",
                status="completed",
        ...
        mrd_milestones = [
            Milestone(
                ...
                project_name="ResidualDisease Test Expansion",
                status="in_progress",
        ...
        active_projects = [
            ...
            ProjectStatus(
                project_name="DiagnosticTest B Enhancement",
                category="product_development",
                overall_status="on_track",
            ...
            ProjectStatus(
                project_name="DiagnosticTest C Platform Upgrade",
                category="technology",
        ...
        timeline_events = [
            TimelineEvent(event_name="DiagnosticTest A 2.0 FDA Submission", event_type="milestone", date="2025-11-30", status="upcoming"),
            TimelineEvent(event_name="ResidualDisease Phase II Completion", event_type="milestone", date="2025-12-15", status="upcoming"),
        ]
        ...
        return ProjectMilestones(
            ...
            critical_items=[
                ...
                "DiagnosticTest C Platform Upgrade experiencing delays - resource allocation needed",
